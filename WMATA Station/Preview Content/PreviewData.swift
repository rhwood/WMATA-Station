...
struct PreviewData {
    ...
    static let stationModels: [Station: StationModel] = [
        .A01: StationModel(StationInformation(address: StationAddress(city: "Washington", state: "DC",
        ...
        .B02: StationModel(StationInformation(address: StationAddress(city: "Washington", state: "DC",
        ...
        .C03: StationModel(StationInformation(address: StationAddress(city: "Washington", state: "DC",
